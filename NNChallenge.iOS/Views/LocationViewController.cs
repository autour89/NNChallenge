...
namespace NNChallenge.iOS.Views
{
    public partial class LocationViewController : UIViewController
    {
        ...
        public LocationViewController()
            : base("LocationViewController", null)
        {
            _viewModel = ServiceProvider.GetService<LocationViewModel>();
        }
        ...
        private void SubmitButtonTouchUpInside(object? sender, EventArgs e)
        {
            ...
            // Use ViewModel to handle location selection
            _viewModel.SelectLocationCommand.Execute(selectedLocation);
